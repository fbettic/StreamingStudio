...
BEGIN
    ...
    FROM Genre
    WHERE genre IN (SELECT value FROM string_split(@genreList, ','))
END
GO
...
BEGIN
    SET NOCOUNT ON;
    -- Concatenar los nombres de los géneros asociados al filmId dado
...
BEGIN
    ...
    -- Insertar los filmId y sus correspondientes listados de géneros en la tabla variable
