...
/**
 * <p>Clase Java para getAssociationDataResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>{@code
 * <complexType name="getAssociationDataResponse">
 *   <complexContent>
...
@XmlType(name = "getAssociationDataResponse", propOrder = {
    "associationRequest"
})
public class GetAssociationDataResponse {
